...
Uma instalação sem catálogo carregado não tem nada para ver, e o painel diz isso. Os exames vêm da página Catálogo de exames, onde um laboratório importa a sua lista. O OpenLDR não traz exames.
