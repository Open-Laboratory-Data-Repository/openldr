...
export const fr: EnShape = {
  ...
  terminology: {
    ...
    del: {
      action: 'Supprimer',
      publisherTitle: 'Supprimer l’éditeur',
      publisherBody: 'Supprime définitivement « {{name}} » avec {{systems}} système(s) de codage et {{terms}} terme(s). Cette action est irréversible.',
      publisherDone: 'Éditeur « {{name}} » supprimé.',
      systemTitle: 'Supprimer le système de codage',
      systemBody: 'Supprime définitivement « {{code}} » avec {{terms}} terme(s) et {{mappings}} correspondance(s). Cette action est irréversible.',
      systemDone: 'Système de codage {{code}} supprimé.',
      systemBlockedFacilities_one: '« {{code}} » ne peut pas être supprimé : 1 établissement est rattaché à ce registre. Leurs identifiants permanents proviennent de son URL, donc le supprimer les rendrait orphelins.',
      systemBlockedFacilities_other: '« {{code}} » ne peut pas être supprimé : {{count}} établissements sont rattachés à ce registre. Leurs identifiants permanents proviennent de son URL, donc le supprimer les rendrait orphelins.',
      systemBlockedValueSet: '« {{code}} » ne peut pas être supprimé : le jeu de valeurs {{valueSet}} l’inclut encore. Retirez-le d’abord de ce jeu de valeurs, sinon le jeu continue de s’étendre sur un système que rien ne peut recréer.',
      systemBlockedMappings_one: '« {{code}} » ne peut pas être supprimé : 1 correspondance active pointe vers lui. Désactivez-la ou supprimez-la d’abord.',
      systemBlockedMappings_other: '« {{code}} » ne peut pas être supprimé : {{count}} correspondances actives pointent vers lui. Désactivez-les ou supprimez-les d’abord.',
      valueSetTitle: 'Supprimer le jeu de valeurs',
      valueSetBody: 'Supprimer définitivement « {{name}} » ? Cette action est irréversible.',
      valueSetDone: 'Jeu de valeurs supprimé.',
      distributionTitle: 'Supprimer la distribution stockée',
      distributionBody: 'Supprime le fichier .zip de distribution {{label}} conservé. Les termes et l’ontologie déjà importés ne sont pas affectés.',
      distributionDone: 'Distribution stockée supprimée.',
    },
  },
  sites: {
  ...
  forms: {
    ...
    browseTitle: 'Parcourir tous les examens',
    browseActions: 'Actions pour {label}',
    browseSearch: 'Rechercher par code ou nom',
    browseCategory: 'Catégorie',
    browseAnyCategory: 'Toutes les catégories',
    browseNotOffered: 'Non proposé ici',
    browseEmpty: "Aucun examen n'est chargé sur cette installation. Les examens viennent de la page Catalogue des examens.",
    browseNoMatch: 'Aucun examen ne correspond à cette recherche.',
    browseError: "Le catalogue n'a pas pu être lu.",
    browseLoading: 'Lecture du catalogue',
  ...
  settings: {
    ...
    general: {
      ...
      about: {
        ...
        upgradeHow: 'Planifiez une interruption avant la mise à jour. Suspendez les envois, vérifiez les sauvegardes et suivez la procédure.',
        upgradeProcedure: 'Procédure de mise à jour planifiée',
  ...
  testCatalog: {
    ...
    sheet: {
    resultParams: 'Paramètres de résultat',
    noResultParams: 'Aucun paramètre de résultat sur cette installation.',
    typeNumeric: 'numérique',
    typeCoded: 'codé',
    typeText: 'texte',
    addBand: 'Ajouter un intervalle',
    removeBand: 'Retirer',
    bandUnit: 'Unité',
    bandName: 'Nom',
    bandLow: 'Borne basse',
    bandHigh: 'Borne haute',
    bandSex: 'Sexe',
    ...
    moveDown: 'Descendre',
      ...
      active: 'Actif',
      enabled: 'Activé ici',
      labSpecimens: 'Prélèvements acceptés',
      localName: 'Nom local',
  ...
  nav: {
    ...
    testCatalog: 'Catalogue des examens',
    audit: 'Audit',
    activity: 'Activité',
    query: 'Requête',
  ...
  facilities: {
    ...
    import: {
      ...
      fileDropHint: 'Glissez un .csv, un .jsonl ou un .xlsx ici, ou cliquez pour parcourir',
      fileDropActive: 'Déposez le fichier pour le choisir',
      fileWrongType: 'Ceci est un fichier {{ext}}. Choisissez un .csv, un .jsonl ou un .xlsx.',
      fileChosen: '{{name}} ({{size}})',
      fileLabel: 'Fichier',
      nationalSystemLabel: 'Registre national',
      ...
      doneTitle: 'Importation terminée',
        ...
        nothingImportedUnknownColumns: 'Des colonnes non reconnues ont empêché la lecture du fichier. Reléchargez-le en les conservant en données supplémentaires.',
      doneSummary: '{{created}} créé(s), {{updated}} mis à jour, {{unchanged}} inchangé(s), {{skipped}} ignoré(s).',
      ...
      changedFieldKeys: '{{field}} : {{keys}} ont changé',
      changedFieldKeysUnnamed: 'le contenu',
      policyTitle: 'Que faire des différences',
      policyHint: 'À décider ici. La Révision indique ce que ces choix produiraient.',
      policyFoundUnknownColumns: 'La dernière vérification a trouvé {{count}} colonne(s) non reconnue(s).',
      policyFoundQuarantined: 'La dernière vérification a trouvé {{count}} ligne(s) mal formée(s).',
      ...
      reuploadUnknownColumnsAction: 'Vérifier de nouveau en conservant les colonnes non reconnues',
      reuploadInvalidCoordinatesAction: 'Vérifier de nouveau en conservant les lignes dont la coordonnée est invalide',
      reuploadColumnMapAction: 'Vérifier de nouveau avec le mappage corrigé',
      validateAllAction: 'Tout valider',
      overrideNeedsReupload: 'Cette option change la façon dont le fichier est lu, donc la vérification doit être relancée avec elle. Utilisez le menu d’actions ci-dessus. Le fichier déjà envoyé est réutilisé, rien n’est donc envoyé deux fois, et le résumé que vous examinerez sera celui qui sera appliqué.',
      ...
      valueMap: {
        notMapped: 'Non mappé',
        ignoreValue: 'Ignorer cette valeur',
        savedCount: '{{count}} mappage(s) enregistré(s).',
        addTypeActions: 'Actions du type à ajouter',
  ...
  dashboard: {
    ...
    creating: 'Création du tableau de bord…',
    created: 'Tableau de bord créé : {{name}}',
    createFailed: 'Impossible de créer le tableau de bord : {{error}}',
    waitForSave: "Attendez la fin de l'enregistrement avant de créer un autre tableau de bord.",
    ...
    filters: {
      ...
      moveDown: 'Descendre',
      remove: 'Supprimer',
      empty: 'Aucun filtre pour l’instant. Ajoutez-en un depuis le menu des actions.',
      variableId: 'Identifiant de variable',
      label: 'Libellé',
      type: 'Type',
      typeText: 'Texte',
      typeNumber: 'Nombre',
      typeDate: 'Date',
      typeDateRange: 'Plage de dates',
      optionsSql: 'SQL des options',
      optionsSqlPlaceholder: 'SELECT DISTINCT ward FROM ...',
      defaultValue: 'Valeur par défaut',
      defaultFrom: 'Début par défaut',
      defaultTo: 'Fin par défaut',
      tokenHelp: 'Écrivez ces jetons dans le SQL du widget. Une plage de dates en produit deux. Une valeur non renseignée devient NULL, sauf si vous entourez sa clause de [[ ]].',
      copyToken: 'Copier',
      copiedToast: 'Jeton copié.',
      copyFailedToast: 'Impossible de copier dans le presse-papiers.',
    },
  },
  widgetEditor: {
  ...
  reportDesigner: {
    ...
    printLanguage: 'Langue d’impression',
    pairTranslations: 'Traductions des paires',
    pairLabel: 'Libellé de la paire',
    pairValue: 'Valeur de la paire',
    designText: 'Texte du modèle',
    paper: 'Papier',
    ...
    showElement: 'Afficher',
    hideElement: 'Masquer',
    lockElement: 'Verrouiller',
    unlockElement: 'Déverrouiller',
    raiseElement: 'Monter',
    lowerElement: 'Descendre',
    ...
    ungroup: 'Dégrouper',
    versions: 'Versions',
    versionsHint: 'Versions publiées de ce modèle. Restaurer en charge une dans la copie de travail comme une modification annulable ; cela ne publie pas.',
    noVersions: 'Aucune version. Publier une révision enregistre le modèle ici.',
    version: 'Version',
    publishedAt: 'Publiée le',
    publishedBy: 'Par',
    restore: 'Restaurer',
    restoreVersion: 'Restaurer la version',
    restoredVersion: 'Version {{n}} restaurée dans la copie de travail',
    spark: 'Tendance',
    sparkFor: 'Dessiner en courbe de tendance pour',
    ruleWhen: 'Quand',
    ruleOpFor: 'Règle pour',
    ruleValueFor: 'Valeur de règle pour',
    ruleStatusFor: 'État de règle pour',
    status_normal: 'Normal',
    status_abnormal: 'Anormal',
    status_critical: 'Critique',
    status_indeterminate: 'Indéterminé',
    status_none: 'Atténué',
    totals: 'Ligne des totaux',
    totalsLabel: 'Libellé des totaux',
    totalsOffHint: 'Vide signifie pas de ligne des totaux',
    sumColumn: 'Sommer',
    sortBy: 'Trier par colonne',
    sortByHelp: 'Les lignes sont ordonnées par cette colonne du résultat avant tout tracé. Le ORDER BY de la requête peut ne pas survivre à l’exécuteur, donc un modèle dont la première ligne compte doit trier ici.',
    headerRow: 'La première ligne de données est l’en-tête',
    headerRowNeedsSort: 'Définissez d’abord Trier par.',
    transposedNote: 'Les en-têtes viennent des données. Un tableau transposé ne lie aucune colonne.',
    cellgridColumnsNote: 'Les colonnes de cellules et les libellés se règlent dans l’onglet Propriétés.',
    chartType: 'Type de graphique',
    chartBar: 'Barres',
    chartLine: 'Ligne',
    chartDonut: 'Anneau',
    valueColumns: 'Colonnes de valeurs',
    addValueColumn: 'Ajouter une colonne de valeurs',
    chartLabelHint: 'Colonne du résultat nommant chaque barre ou point. Laisser vide pour les numéroter.',
    donutFirstOnly: 'Un anneau n’utilise que la première colonne de valeurs.',
    chartColumnsNote: 'Le type et les colonnes du graphique se règlent dans l’onglet Propriétés.',
    labelColumn: 'Colonne des libellés',
    labelColumnHint: 'Colonne du résultat portant le nom de chaque ligne. Laisser vide pour une grille sans bande de libellés.',
    cellColumns: 'Colonnes de cellules',
    addCellColumn: 'Ajouter une colonne de cellules',
    paletteSteps: 'Paliers de la palette',
    groupBoundary: 'Espace au changement de groupe',
    trailingColumns: 'Colonnes de fin',
    addTrailingColumn: 'Ajouter une colonne de fin',
    trailingKey: 'Clé de colonne',
    trailingLabel: 'Libellé de colonne',
    trailingWidth: 'Largeur de colonne (points)',
    trailingWidthHint: 'Les largeurs sont en points, pas en pixels : 20 points font environ 27 pixels.',
    flow: 'Enchaînement',
    placeBelow: 'Placer sous',
    flowGap: 'Espace après',
    firstPageOnly: 'Première page seulement',
    showWith: 'Afficher avec',
    fillToBottom: 'Remplir jusqu’au bas du cadre',
    moveUp: 'Monter',
    moveDown: 'Descendre',
    parameters: 'Paramètres',
    ...
    defaultFrom: 'Début par défaut',
    defaultTo: 'Fin par défaut',
    paramsHint: 'Les filtres que ce rapport demande à l’exécution. La clé doit correspondre à l’identifiant de variable de la requête ; le libellé est ce que voit la personne qui lance le rapport ; les valeurs saisies ici ne sont que des valeurs par défaut et alimentent Charger les colonnes et Charger les pages.',
    paramTypeText: 'Texte',
