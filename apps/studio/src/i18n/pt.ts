...
export const pt: EnShape = {
  ...
  terminology: {
    ...
    del: {
      action: 'Eliminar',
      publisherTitle: 'Eliminar o editor',
      publisherBody: 'Elimina definitivamente “{{name}}” com {{systems}} sistema(s) de codificação e {{terms}} termo(s). Esta ação é irreversível.',
      publisherDone: 'Editor “{{name}}” eliminado.',
      systemTitle: 'Eliminar o sistema de codificação',
      systemBody: 'Elimina definitivamente “{{code}}” com {{terms}} termo(s) e {{mappings}} correspondência(s). Esta ação é irreversível.',
      systemDone: 'Sistema de codificação {{code}} eliminado.',
      systemBlockedFacilities_one: '“{{code}}” não pode ser eliminado: 1 estabelecimento está registado neste registo. Os seus identificadores permanentes derivam do URL, por isso eliminá-lo deixaria todos órfãos.',
      systemBlockedFacilities_other: '“{{code}}” não pode ser eliminado: {{count}} estabelecimentos estão registados neste registo. Os seus identificadores permanentes derivam do URL, por isso eliminá-lo deixaria todos órfãos.',
      systemBlockedValueSet: '“{{code}}” não pode ser eliminado: o conjunto de valores {{valueSet}} ainda o inclui. Remova-o primeiro desse conjunto de valores, ou o conjunto continua a expandir-se sobre um sistema que nada consegue recriar.',
      systemBlockedMappings_one: '“{{code}}” não pode ser eliminado: 1 correspondência ativa aponta para ele. Desative-a ou elimine-a primeiro.',
      systemBlockedMappings_other: '“{{code}}” não pode ser eliminado: {{count}} correspondências ativas apontam para ele. Desative-as ou elimine-as primeiro.',
      valueSetTitle: 'Eliminar o conjunto de valores',
      valueSetBody: 'Eliminar definitivamente “{{name}}”? Esta ação é irreversível.',
      valueSetDone: 'Conjunto de valores eliminado.',
      distributionTitle: 'Eliminar a distribuição guardada',
      distributionBody: 'Elimina o ficheiro .zip de distribuição {{label}} guardado. Os termos e a ontologia já importados não são afetados.',
      distributionDone: 'Distribuição guardada eliminada.',
    },
  },
  sites: {
    ...
    noMatch: 'Nenhum site corresponde aos filtros atuais.',
  ...
  forms: {
    ...
    browseTitle: 'Ver todos os exames',
    browseActions: 'Ações de {label}',
    browseSearch: 'Pesquisar por código ou nome',
    browseCategory: 'Categoria',
    browseAnyCategory: 'Qualquer categoria',
    browseNotOffered: 'Não oferecido aqui',
    browseEmpty: 'Não há exames carregados nesta instalação. Os exames vêm da página Catálogo de exames.',
    browseNoMatch: 'Nenhum exame corresponde a esta pesquisa.',
    browseError: 'Não foi possível ler o catálogo.',
    browseLoading: 'A ler o catálogo',
  ...
  settings: {
    ...
    general: {
      ...
      about: {
        ...
        upgradeHow: 'Planeie uma paragem antes de atualizar. Pause os envios, verifique as cópias de segurança e siga o procedimento.',
        upgradeProcedure: 'Procedimento de atualização planeada',
        checkForUpdates: 'Verificação automática de atualizações',
        lastChecked: 'Última verificação {{when}}',
        neverChecked: 'Nunca verificado',
        checkFailed: 'A última verificação falhou: {{error}}.',
      },
      flags: {
    ...
    connectors: {
      ...
      noMatch: 'Nenhum conector corresponde aos filtros atuais.',
    ...
    marketplace: {
      ...
      registrySearchPlaceholder: 'Pesquisar registos',
      noMatchRegistries: 'Nenhum registo corresponde.',
      registryActions: 'Ações do registo',
      registryActionsFor: 'Ações para {{name}}',
      registryEditBtn: 'Editar',
      registryRemoveBtn: 'Remover',
      registryErrorToast: 'Erro de registo: {{error}}',
      registrySavedToast: 'Registo {{name}} guardado',
    },
    dataExposure: {
  ...
  activity: {
    ...
    noMatch: 'Nenhuma carga corresponde.',
    noSource: 'Nenhuma',
  ...
  audit: {
    ...
    colActor: 'Ator',
    colAction: 'Ação',
    colEntityType: 'Tipo de entidade',
    colEntityId: 'ID da entidade',
    searchPlaceholder: 'Pesquisar eventos de auditoria',
    noMatch: 'Nenhum evento de auditoria corresponde.',
    actions: 'Ações',
    refresh: 'Atualizar',
  },
  notifications: {
    ...
    body: {
      ...
      update_available: 'A versão {{version}} está disponível. Esta instalação utiliza {{running}}.',
    },
    history: {
      viewAll: 'Ver tudo',
      time: 'Hora',
  ...
  testCatalog: {
    ...
    empty: 'Nenhum exame ativo. Os exames retirados ficam ocultos, exceto se filtrar por eles.',
    ...
    sheet: {
    resultParams: 'Parâmetros de resultado',
    noResultParams: 'Nenhum parâmetro de resultado nesta instalação.',
    typeNumeric: 'numérico',
    typeCoded: 'codificado',
    typeText: 'texto',
    addBand: 'Adicionar intervalo',
    removeBand: 'Remover',
    bandUnit: 'Unidade',
    bandName: 'Nome',
    bandLow: 'Limite inferior',
    bandHigh: 'Limite superior',
    bandSex: 'Sexo',
  ...
  nav: {
    ...
    users: 'Utilizadores',
    facilities: 'Unidades',
    testCatalog: 'Catálogo de exames',
    audit: 'Auditoria',
    activity: 'Atividade',
    query: 'Consulta',
  ...
  facilities: {
    ...
    import: {
      ...
      fileDropHint: 'Arraste um .csv, um .jsonl ou um .xlsx para aqui, ou clique para procurar',
      fileDropActive: 'Largue o ficheiro para o escolher',
      fileWrongType: 'Isto é um ficheiro {{ext}}. Escolha um .csv, um .jsonl ou um .xlsx.',
      ...
      registerSourceNamePlaceholder: 'Registo nacional de unidades de saúde',
      ...
      policyFoundQuarantined: 'A última verificação encontrou {{count}} linha(s) mal formada(s).',
      ...
      reuploadUnknownColumnsAction: 'Verificar de novo mantendo as colunas não reconhecidas',
      reuploadInvalidCoordinatesAction: 'Verificar de novo mantendo as linhas com coordenada inválida',
      reuploadColumnMapAction: 'Verificar de novo com o mapeamento corrigido',
      validateAllAction: 'Validar tudo',
      overrideNeedsReupload: 'Esta opção altera a forma como o ficheiro é lido, por isso a verificação tem de correr de novo com ela. Use o menu de ações acima. O ficheiro que já enviou é reutilizado, por isso nada é enviado duas vezes, e o resumo que analisar será o que será aplicado.',
      ...
      valueMap: {
        ...
        addTypeActions: 'Ações para adicionar tipo',
  ...
  dashboard: {
    ...
    creating: 'A criar painel…',
    created: 'Painel criado: {{name}}',
    createFailed: 'Não foi possível criar o painel: {{error}}',
    waitForSave: 'Aguarde até guardar as alterações antes de criar outro painel.',
    ...
    filters: {
      ...
      actions: 'Ações do filtro',
      add: 'Adicionar filtro',
      save: 'Guardar',
      cancel: 'Cancelar',
      rowActions: 'Ações para {{id}}',
      moveUp: 'Mover para cima',
      moveDown: 'Mover para baixo',
      remove: 'Remover',
      empty: 'Ainda não há filtros. Adicione um a partir do menu de ações.',
      variableId: 'Identificador da variável',
      label: 'Rótulo',
      type: 'Tipo',
      typeText: 'Texto',
      typeNumber: 'Número',
      typeDate: 'Data',
      typeDateRange: 'Intervalo de datas',
      ...
      tokenHelp: 'Escreva estes tokens no SQL do widget. Um intervalo de datas produz dois. Um valor por preencher torna-se NULL, a menos que envolva a cláusula em [[ ]].',
      copyToken: 'Copiar',
      copiedToast: 'Token copiado.',
      copyFailedToast: 'Não foi possível copiar para a área de transferência.',
    },
  },
  widgetEditor: {
  ...
  reportDesigner: {
    ...
    pairTranslations: 'Traduções dos pares',
    pairLabel: 'Rótulo do par',
    pairValue: 'Valor do par',
    ...
    showElement: 'Mostrar',
    hideElement: 'Ocultar',
    lockElement: 'Bloquear',
    unlockElement: 'Desbloquear',
    raiseElement: 'Subir',
    lowerElement: 'Baixar',
    ...
    pageCountStale: 'Editado desde o último carregamento',
    showData: 'Mostrar dados',
    showDataNeedsLoad: 'Carregue as páginas para ver os dados reais',
    loadPages: 'Carregar páginas',
    physicalPage: 'Página física',
    groupSelection: 'Agrupar seleção',
    newGroupName: 'Grupo',
    ungroup: 'Desagrupar',
    versions: 'Versões',
    versionsHint: 'Versões publicadas deste modelo. Restaurar carrega uma na cópia de trabalho como uma edição reversível; não publica.',
    noVersions: 'Ainda sem versões. Publicar uma revisão guarda o modelo aqui.',
    version: 'Versão',
    publishedAt: 'Publicada em',
    publishedBy: 'Por',
    restore: 'Restaurar',
    restoreVersion: 'Restaurar versão',
    restoredVersion: 'Versão {{n}} restaurada na cópia de trabalho',
    spark: 'Tendência',
    sparkFor: 'Desenhar como linha de tendência para',
    ruleWhen: 'Quando',
    ruleOpFor: 'Regra para',
    ruleValueFor: 'Valor da regra para',
    ruleStatusFor: 'Estado da regra para',
    status_normal: 'Normal',
    status_abnormal: 'Anormal',
    status_critical: 'Crítico',
    status_indeterminate: 'Indeterminado',
    status_none: 'Atenuado',
    totals: 'Linha de totais',
    totalsLabel: 'Rótulo dos totais',
    totalsOffHint: 'Vazio significa sem linha de totais',
    sumColumn: 'Somar',
    sortBy: 'Ordenar pela coluna',
    sortByHelp: 'As linhas são ordenadas por esta coluna do resultado antes de qualquer desenho. O ORDER BY da própria consulta pode não sobreviver ao executor, por isso um modelo cuja primeira linha importa deve ordenar aqui.',
    headerRow: 'A primeira linha de dados é o cabeçalho',
    headerRowNeedsSort: 'Defina primeiro Ordenar pela coluna.',
    transposedNote: 'Os cabeçalhos vêm dos dados. Uma tabela transposta não vincula colunas.',
    cellgridColumnsNote: 'As colunas de células e os rótulos definem-se no separador Propriedades.',
    chartType: 'Tipo de gráfico',
    chartBar: 'Barras',
    chartLine: 'Linha',
    chartDonut: 'Anel',
    valueColumns: 'Colunas de valores',
    addValueColumn: 'Adicionar coluna de valores',
    chartLabelHint: 'Coluna do resultado que nomeia cada barra ou ponto. Deixe em branco para os numerar.',
    donutFirstOnly: 'Um anel usa apenas a primeira coluna de valores.',
    chartColumnsNote: 'O tipo e as colunas do gráfico definem-se no separador Propriedades.',
    labelColumn: 'Coluna de rótulos',
    labelColumnHint: 'Coluna do resultado com o nome de cada linha. Deixe em branco para uma grelha sem faixa de rótulos.',
    cellColumns: 'Colunas de células',
    addCellColumn: 'Adicionar coluna de células',
    paletteSteps: 'Níveis da paleta',
    groupBoundary: 'Espaço na mudança de grupo',
    trailingColumns: 'Colunas finais',
    addTrailingColumn: 'Adicionar coluna final',
    trailingKey: 'Chave da coluna',
    trailingLabel: 'Rótulo da coluna',
    trailingWidth: 'Largura da coluna (pontos)',
    trailingWidthHint: 'As larguras são em pontos, não em píxeis: 20 pontos são cerca de 27 píxeis.',
    flow: 'Fluxo',
    placeBelow: 'Colocar abaixo de',
    flowGap: 'Espaço depois',
    firstPageOnly: 'Apenas na primeira página',
    showWith: 'Mostrar com',
    fillToBottom: 'Preencher até ao fundo da caixa',
    moveUp: 'Mover para cima',
    moveDown: 'Mover para baixo',
    parameters: 'Parâmetros',
    ...
    defaultFrom: 'Início predefinido',
    defaultTo: 'Fim predefinido',
    paramsHint: 'Os filtros que este relatório pede ao ser executado. A chave deve corresponder ao ID de variável da consulta; o rótulo é o que a pessoa que executa o relatório vê; os valores aqui são apenas predefinições e alimentam Carregar colunas e Carregar páginas.',
    paramTypeText: 'Texto',
    ...
    element: {
      ...
      keyvalue: 'Painel chave/valor', barcode: 'Código de barras', qrcode: 'Código QR', cellgrid: 'Grelha de células', chart: 'Gráfico', letterhead: 'Cabeçalho do laboratório',
    },
