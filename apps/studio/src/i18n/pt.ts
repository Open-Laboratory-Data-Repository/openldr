...
export const pt: EnShape = {
  ...
  facilities: {
    ...
    import: {
      ...
      editUndoSweep: 'Desfazer esta alteração em toda a coluna',
      editScopeTitle: 'Alterar este valor onde?',
      editScopeBody: 'A coluna {{header}} tem "{{from}}" aqui. Foi alterado para "{{to}}".',
      editScopeRow: 'Só esta linha',
      editScopeEverywhere: 'Todas as linhas com este valor',
      raggedRowNote: 'Esta linha não pode ser corrigida aqui. O número de colunas não corresponde ao cabeçalho. Corrija-a no CSV.',
      editWriteFailed: 'Não foi possível guardar esta alteração.',
