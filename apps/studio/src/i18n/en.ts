export const en = {
  ...
  forms: {
    ...
    browseTitle: 'Browse all tests',
    browseActions: '{label} actions',
    browseSearch: 'Search by code or name',
    browseCategory: 'Category',
    browseAnyCategory: 'Any category',
    browseNotOffered: 'Not offered here',
    browseEmpty: 'No tests are loaded on this install. Tests come from the Test catalog page.',
    browseNoMatch: 'No tests match this search.',
    browseError: 'The catalog could not be read.',
    browseLoading: 'Reading the catalog',
  ...
  settings: {
    ...
    general: {
      ...
      about: {
        ...
        upgradeHow: 'Schedule downtime before upgrading. Pause senders, verify backups, and follow the procedure.',
        upgradeProcedure: 'Planned upgrade procedure',
  ...
  testCatalog: {
    ...
    noResultParams: 'No result parameters are loaded on this install.',
    typeNumeric: 'numeric',
    typeCoded: 'coded',
    typeText: 'text',
    addBand: 'Add band',
  ...
  facilities: {
    ...
    import: {
      ...
      fileDropHint: 'Drag a .csv, .jsonl or .xlsx here, or click to browse',
      fileDropActive: 'Drop the file to choose it',
      fileWrongType: 'That is a {{ext}} file. Choose a .csv, a .jsonl or a .xlsx.',
      ...
      policyFoundQuarantined: 'The last check found {{count}} malformed row(s).',
      ...
      valueMap: {
        ...
        addTypeActions: 'Add type actions',
  ...
  dashboard: {
    ...
    created: 'Created dashboard: {{name}}',
    createFailed: 'Could not create dashboard: {{error}}',
    waitForSave: 'Wait for your changes to save before creating another dashboard.',
    ...
    filters: {
      ...
      moveDown: 'Move down',
      remove: 'Remove',
      empty: 'No filters yet. Add one from the actions menu.',
      ...
      // The token names are built in the component, never interpolated here: an i18next value
      // containing {{ }} is not re-interpolated, so it would render as literal braces.
      tokenHelp: 'Write these tokens in widget SQL. A date range splits into two. An unset value becomes NULL, unless you wrap its clause in [[ ]].',
      copyToken: 'Copy',
      copiedToast: 'Token copied.',
      copyFailedToast: 'Could not copy to the clipboard.',
    },
  },
  widgetEditor: {
    insertToken: 'Insert',
  ...
  reportDesigner: {
    ...
    pairTranslations: 'Pair translations',
    ...
    ungroup: 'Ungroup',
    versions: 'Versions',
    versionsHint: 'Published versions of this design. Restoring loads one into the working copy as an edit you can undo; it does not publish.',
    noVersions: 'No versions yet. Publishing a revision snapshots the design here.',
    version: 'Version',
    publishedAt: 'Published',
    publishedBy: 'By',
    restore: 'Restore',
    restoreVersion: 'Restore version',
    restoredVersion: 'Restored version {{n}} into the working copy',
    spark: 'Trend',
    sparkFor: 'Draw as a trend line for',
    ruleWhen: 'When',
    ruleOpFor: 'Rule for',
    ruleValueFor: 'Rule value for',
    ruleStatusFor: 'Rule status for',
    ...
    totalsOffHint: 'Blank means no totals row',
    sumColumn: 'Sum',
    sortBy: 'Sort by column',
    sortByHelp: 'Rows are ordered by this result column before anything draws. The query’s own ORDER BY may not survive the runner, so a design whose first row matters must sort here.',
    headerRow: 'First data row is the header',
    headerRowNeedsSort: 'Set Sort by first.',
    transposedNote: 'Headers come from the data. A transposed table binds no columns.',
    cellgridColumnsNote: 'Cell columns and labels are set in the Properties tab.',
    chartType: 'Chart type',
    chartBar: 'Bar',
    chartLine: 'Line',
    chartDonut: 'Donut',
    valueColumns: 'Value columns',
    addValueColumn: 'Add value column',
    chartLabelHint: 'Result column naming each bar or point. Leave blank to number them.',
    donutFirstOnly: 'A donut uses the first value column only.',
    chartColumnsNote: 'Chart type and columns are set in the Properties tab.',
    labelColumn: 'Label column',
    labelColumnHint: 'Result column holding each row’s name. Leave blank for a grid with no label strip.',
    cellColumns: 'Cell columns',
    addCellColumn: 'Add cell column',
    paletteSteps: 'Palette steps',
    groupBoundary: 'Gap at group change',
    trailingColumns: 'Trailing columns',
    addTrailingColumn: 'Add trailing column',
    trailingKey: 'Column key',
    trailingLabel: 'Column label',
    trailingWidth: 'Column width (points)',
    trailingWidthHint: 'Widths are points, not pixels: 20 points is about 27 pixels.',
    flow: 'Flow',
    placeBelow: 'Place below',
    flowGap: 'Gap after',
    firstPageOnly: 'First page only',
    showWith: 'Show with',
    fillToBottom: 'Fill to bottom of box',
    moveUp: 'Move up',
    moveDown: 'Move down',
    parameters: 'Parameters',
    ...
    defaultFrom: 'Default from',
    defaultTo: 'Default to',
    paramsHint: 'The filters this report asks for when it runs. Key must match the query’s variable ID; Label is what the person running the report sees; values here are only defaults, and they feed Load columns and Load pages.',
    paramTypeText: 'Text',
