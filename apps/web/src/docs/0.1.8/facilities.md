...
After Create or Save, the registry reloads the current filtered and sorted page. A saved facility may belong on another page or fall outside the filter. Search for its code to check it. The page size stays bounded.
