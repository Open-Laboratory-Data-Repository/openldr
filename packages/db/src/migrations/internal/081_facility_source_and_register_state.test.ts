...
describe('081 facility source + register state', () => {
  ...
  // version of this test seeded an imported row and a manual row AFTER makeMigratedDb() — but
  // makeMigratedDb() runs every migration (including this one) FIRST, so both rows land on the
