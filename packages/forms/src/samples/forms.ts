...
const orderForm: FormSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      cardinality: { min: 0, max: '1' },
      section: 'order',
      // Bench result entry: the specimen, rejection and result values for each chosen test. It reads
      // the Tests answer the same way the specimen picker does (test catalog S4).
