    ...
    pages: [
      {
        ...
        elements: [
          ...
          {
            id: `${spec.id}-table`, kind: 'table', name: 'Data', rect: { x: 48, y: tableY, w: 700, h: 1000 - tableY - 8 },
            dataSource: { kind: 'custom-query', queryId: spec.queryId },
            boundColumns: spec.columns,
          },
          { id: `${spec.id}-rule2`, kind: 'line', name: 'rule2', rect: { x: 48, y: 1000, w: 700, h: 0 }, style: { strokeColor: '#cbd5e1', strokeWidth: 0.75 } },
          { id: `${spec.id}-foot`, kind: 'text', name: 'Footer', rect: { x: 48, y: 1012, w: 500, h: 16 }, text: 'Generated by OpenLDR — figures reflect data available at time of generation.', style: { fontSize: 7, color: '#94a3b8' } },
        ],
      },
    ],
    pageNumbers: true,
